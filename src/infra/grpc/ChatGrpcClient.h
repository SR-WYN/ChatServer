...
class ChatGrpcClient : public Singleton<ChatGrpcClient>, public IChatServiceClient
{
...
public:
    ...
    TextChatMsgRsp NotifyTextChatMsg(const std::string &rpc_host, const std::string &rpc_port,
                                     const TextChatMsgReq &req, const Json::Value &root_value) override;
